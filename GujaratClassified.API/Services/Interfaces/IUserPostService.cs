...
namespace GujaratClassified.API.Services.Interfaces
{
    public interface IUserPostService
    {
        ...
        Task<ApiResponse<PostListWithPaginationResponse>> GetMyPostsAsync(int userId, string? status, int pageSize, int pageNumber);
        ...
        Task<ApiResponse<PostListWithPaginationResponse>> GetUserFavoritesAsync(int userId, int pageSize, int pageNumber);
